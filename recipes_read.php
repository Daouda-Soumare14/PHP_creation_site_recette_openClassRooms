...
$retrieveRecipeWithCommentsStatement = $mysqlClient->prepare('SELECT r.*, c.comment_id, c.comment, c.user_id, u.nomPrenom FROM recipes r 
        ...
        <div class="row">
            <?php foreach ($recipe['comments'] as $comment) : ?>
                <div class="comment">
                    ...
                    <i>(<?php echo $comment['nomPrenom']; ?>)</i>
                </div>
            <?php endforeach; ?>
        </div>
        <?php else : ?>
